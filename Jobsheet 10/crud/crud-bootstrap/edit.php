...
<html> 
    ...
    <body> <?php include('koneksi.php'); $id = $_GET['id']; $query = "SELECT * FROM anggota WHERE id = $id"; $result = mysqli_query($koneksi, $query); $row = mysqli_fetch_assoc($result); mysqli_close($koneksi); ?> 
    <div class="container mt-4"> 
        ...
        <form action="proses.php?aksi=ubah" method="post"> 
            ...
            <div class="form-group"> 
                ...
                <div class="form-check"> <input type="radio" class="form-check-input" name="jenis_kelamin" value="L" id="laki" <?php if ($row['jenis_kelamin'] == 'L') echo 'checked'; ?> required> 
        ...
        <div class="form-group"> 
            ...
            <input type="text" class="form-control" name="alamat" id="alamat" value="<?php echo $row['alamat']; ?>" required> </div> 
            <div class="form-group"> 
